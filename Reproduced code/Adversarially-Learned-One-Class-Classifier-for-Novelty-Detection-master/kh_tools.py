...
def read_image(s_image_path):
    #tmp_image = np.array(scipy.misc.imread(s_image_path))#/127.5 -1.
    tmp_image=cv2.imread(s_image_path,flags=cv2.IMREAD_GRAYSCALE)
...
def get_image_patches(image_src, nd_patch_size, nd_stride):
    ...
    while i < n_frame_h and flag_permission_h:
        ...
        while j < n_frame_w and flag_permission_w:
            ...
            #if [start_h,start_w] not in lst_locations:
...
#a,b=read_lst_images(['2.png'],(30,20),(8,5))
